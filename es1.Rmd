...
BaseMat = as.matrix(read_csv('BaseMat.csv'))        # matrix Phi, dim = 200 x 40
y_hat_true = as.matrix(read_csv('y_hat_true.csv'))  # y true, dim = 300 x 200
beta_true = as.matrix(read_csv('beta_true.csv'))    # beta, dim = 300 x 40
mu_true = as.matrix(read_csv('mu_true.csv'))        # mu true, dim = 40 x 1
